...
class _Page1State extends State<Page1> {
  final List sections = [
    {
      "title": "প্রথম পাঠ",
      "page_range": "০১ - ১০ পৃষ্ঠা",
      "content": [
        {
          "section_title": "নিয়ত",
          "text": "খোদাপ্রাপ্তি জ্ঞানের আলোকেখোদাপ্রাপ্তি জ্ঞানের আলোকে ",
          "audio": "https://example.com/audio/niyat.mp3"
        }
      ]
    },
    {
      "title": "দ্বিতীয় পাঠ",
      "page_range": "১১ - ২০ পৃষ্ঠা",
      "content": [
        {
          "section_title": "আদব",
          "text": "আদবের মর্যাদা সম্পর্কে ...",
          "audio": "https://example.com/audio/adab.mp3"
        }
      ]
    },
    {
      "title": "তৃতীয় পাঠ",
      "page_range": "২১ - ৩০ পৃষ্ঠা",
      "content": [
        {
          "section_title": "শ্রদ্ধা",
          "text": "আল্লাহর শ্রদ্ধাবোধ এবং অন্যের প্রতি দয়া ...",
          "audio": "https://example.com/audio/shroddha.mp3"
        }
      ]
    },
    {
      "title": "চতুর্থ পাঠ",
      "page_range": "৩১ - ৪০ পৃষ্ঠা",
      "content": [
        {
          "section_title": "ধৈর্য",
          "text": "ধৈর্যের গুরুত্ব ও প্রয়োজনীয়তা ...",
          "audio": "https://example.com/audio/dhoirjo.mp3"
        }
      ]
    },
    {
      "title": "পঞ্চম পাঠ",
      "page_range": "৪১ - ৫০ পৃষ্ঠা",
      "content": [
        {
          "section_title": "সহমর্মিতা",
          "text": "সহমর্মিতার প্রভাব ...",
          "audio": "https://example.com/audio/shohomormita.mp3"
        }
      ]
    },
    {
      "title": "ষষ্ঠ পাঠ",
      "page_range": "৫১ - ৬৩ পৃষ্ঠা",
      "content": [
        {
          "section_title": "বিশ্বাস",
          "text": "আল্লাহর প্রতি বিশ্বাস এবং এর প্রভাব ...",
          "audio": "https://example.com/audio/bishash.mp3"
        }
      ]
    }
  ];
                  ...
                  children: [
                    Container(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: Color(0xffABD3DB)),
                        child: Padding(
  ...
  Widget _buildContainerToNavigate(
      Size screenSize, String title, String pageRange, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
      child: Container(
        ...
        children: [
          Container(
            ...
            child: PageView.builder(
              ...
              physics:
              BouncingScrollPhysics(), // Optional: Adds a bouncing effect
            ),
          ),
          isClicked == false
              ? Positioned(
            ...
            child: ElevatedButton(
              ...
              style: ButtonStyle(
                  backgroundColor:
                  MaterialStateProperty.all(Color(0xffFFF3F3))),
              child: Row(
                children: [
                  Icon(
                      isClicked ? Icons.pause : Icons.play_circle_rounded,
                      color: Color(0xffABD3DB)),
                  SizedBox(width: 5),
                  Text(
                    isClicked ? "বন্ধ করুন" : "অডিও শুনুন",
                    style: const TextStyle(
                        fontSize: 15, color: Color(0xffABD3DB)),
                  ),
                ],
              ),
            ),
                            ...
                            children: [
                              SliderTheme(
                                data: SliderTheme.of(context).copyWith(
                                  trackHeight:
                                  2.0, // Adjust the slider thickness here
                                ),
                                child: Container(
                                  width: 200,
                                  child: Slider(
